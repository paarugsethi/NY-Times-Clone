...
function prin_div(data) {
    ...
    <a href="${data.results.books[1].amazon_product_url}"><img class="news-poster" src="${data.results.books[1].book_image}"></a>
    <p class="Text_mute">${data.results.books[1].author.toUpperCase()}<p>
   <a href="${data.results.books[1].amazon_product_url}"> <h2 class="news_title">${data.results.books[1].title}</h2></a>
    <p>${data.results.books[1].description}</p>
    </div>
    <div class="news_inner_small-div div2">
    <a href="${data.results.books[4].amazon_product_url}"><img class="news-poster" src="${data.results.books[4].book_image}" ></a>
    <p class="Text_mute">${data.results.books[4].author.toUpperCase()}<p>
    <a href="${data.results.books[4].amazon_product_url}"><h2 class="news_title">${data.results.books[4].title}</h2></a>
    <p>${data.results.books[4].description}</p>
    </div>
    <div class="div3">
    <div class="story">
    <a href="${data.results.books[7].amazon_product_url}"><h2 class="news_title">${data.results.books[7].title}</h2></a>
    <div>
    <p class="abstract">${data.results.books[7].description}</p>
    <a href="${data.results.books[7].amazon_product_url}"><img class="small-poster small" src="${data.results.books[7].book_image}" ></a>
    </div>
    <p class="Text_mute">${data.results.books[7].author.toUpperCase()}<p>
    
    </div>
    <hr>
    <div class="story display-non">
    <a href="${data.results.books[9].amazon_product_url}"><h2 class="news_title">${data.results.books[9].title}</h2></a>
    <div>
    <p class="abstract">${data.results.books[9].description}</p>
    <a href="${data.results.books[9].amazon_product_url}"><img class="small-poster" src="${data.results.books[9].book_image}"></a>
    </div>
    <p class="Text_mute">${data.results.books[9].author.toUpperCase()}<p>
    ...
    <a href="${data.results.books[9].amazon_product_url}">
    <img src="${data.results.books[9].book_image}" class="card-poster" /></a>
    <a href="${data.results.books[9].amazon_product_url}">
    <h4>${data.results.books[9].title}</h4></a>
    <p>${data.results.books[9].description}</p>
    </div>
    <div class="titlePoster">
    <a href="${data.results.books[14].amazon_product_url}">
    <img src="${data.results.books[14].book_image}" class="card-poster"  /></a>
    <a href="${data.results.books[14].amazon_product_url}">
    <h4>${data.results.books[14].title}</h4></a>
    <p>${data.results.books[14].description}</p>
    </div>
    <div class="titlePoster">
    <a href="${data.results.books[11].amazon_product_url}">
    <img src="${data.results.books[11].book_image}" class="card-poster"  /></a>
    <a href="${data.results.books[11].amazon_product_url}">
    <h4>${data.results.books[11].title}</h4></a>
    <p>${data.results.books[11].description}</p>
    </div>
    <div class="titlePoster">
    <a href="${data.results.books[10].amazon_product_url}">
    <img src="${data.results.books[10].book_image}" class="card-poster"  /></a>
    <a href="${data.results.books[10].amazon_product_url}">
    <h4>${data.results.books[10].title}</h4></a>
    <p>${data.results.books[10].description}</p>
    </div>
    <div class="titlePoster bor">
    <a href="${data.results.books[8].amazon_product_url}">
    <img src="${data.results.books[8].book_image}" class="card-poster"  /></a>
    <a href="${data.results.books[8].amazon_product_url}">
    <h4>${data.results.books[8].title}</h4></a>
    <p>${data.results.books[8].description}</p>
    </div>
    `
    ...
    saturday.innerHTML = `
    <button><a href="">More in The Books ot the time <i class="fas fa-angle-right"></i></a></button>
    <h3>Books of The Times</h3>
    <div id="timespenish_div">
    <div class="timespenish_inner nopad">
    <a href="${data.results.books[2].amazon_product_url}"><img id="img-size" src="${data.results.books[2].book_image}"/></a>
      <div>
      <a href="${data.results.books[2].amazon_product_url}"><h4>${data.results.books[2].title}</h4></a>
      <p>${data.results.books[2].description}</p>
      </div>
        </div>
      <div class="timespenish_inner">
      <a href="${data.results.books[4].amazon_product_url}"><img id="img-size" src="${data.results.books[4].book_image}"/></a>
      <div>
      <a href="${data.results.books[4].amazon_product_url}"> <h4>${data.results.books[4].title}</h4></a>
      <p>${data.results.books[4].description}</p>
     </div>
        </div>
       <div class="timespenish_inner">
       <a href="${data.results.books[8].amazon_product_url}"><img id="img-size" src="${data.results.books[8].book_image}"/></a>
      <div>
      <a href="${data.results.books[8].amazon_product_url}"><h4>${data.results.books[8].title}</h4></a>
      <p>${data.results.books[8].description}</p>
     </div>
        </div>
         <div class="timespenish_inner">
         <a href="${data.results.books[6].amazon_product_url}"><img id="img-size" src="${data.results.books[6].book_image}"/></a>
      <div>
      <a href="${data.results.books[6].amazon_product_url}"><h4>${data.results.books[6].title}</h4></a>
      <p>${data.results.books[6].description}</p>
      </div>
        </div>
       <div class="timespenish_inner bor">
       <a href="${data.results.books[13].amazon_product_url}"><img id="img-size" src="${data.results.books[13].book_image}"/></a>
       <div>
       <a href="${data.results.books[13].amazon_product_url}"><h4>${data.results.books[13].title}</h4></a>
       <p>${data.results.books[13].description}</p>
      </div>
        </div>
...
function showData(data){
    ...
    result.innerHTML = "";
        result.innerHTML = data.results.books.map((news)=>{
            return `
            <div class="latest-item">
            <div>
            <a href="${news.amazon_product_url}">
            <h3>${news.title}</h3>
            <p class="latest_para">${news.description}</p>
           </div>
           <div>
